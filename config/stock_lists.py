...
class StockLists:
    ...
    # Mean reversion based on optimal volatility research (ATR <1.5%, beta 1.2-1.8, vol 20-40%)
    MEAN_REVERSION = [
    ...
    def get_stocks_for_strategy(cls, strategy_name: str) -> list:
        ...
        return strategy_mapping.get(strategy_name, cls.MEAN_REVERSION)
